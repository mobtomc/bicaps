                ...
                <div className="flex-1 flex flex-col items-center justify-center">
                  <ul className="flex flex-col w-full text-center">
                    ...
                    <li className="text-lg my-2 relative group">
                      ...
                      <ul className="absolute left-0 top-full mt-1 w-48 bg-white dark:bg-gray-800 shadow-lg rounded-lg hidden group-hover:block">
                        <li className="text-lg my-2">
                        ...
                        <li className="text-lg my-2">
                          <a href="/addclients" className="block py-2 px-4 text-gray-900 rounded hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" onClick={() => setIsMenuOpen(false)}>Add Clients</a>
                        </li>
                      </ul>
                    </li>
                    <li className="text-lg my-2 relative group">
                      ...
                      <ul className="absolute left-0 top-full mt-1 w-48 bg-white dark:bg-gray-800 shadow-lg rounded-lg hidden group-hover:block">
                        ...
                        <li className="text-lg my-2">
                          <a href="/newentity" className="block py-2 px-4 text-gray-900 rounded hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" onClick={() => setIsMenuOpen(false)}>New Entity</a>
                        </li>
                        <li className="text-lg my-2">
            ...
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 items-center">
              ...
              <li className="relative group">
                ...
                <ul className="absolute left-0 top-full mt-1 w-48 bg-white dark:bg-gray-800 shadow-lg rounded-lg hidden group-hover:block">
                  ...
                  <li>
                    <a href="/newentity" className="block py-2 px-4 text-gray-900 rounded hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"> Entity</a>
                  </li>
                  <li>
